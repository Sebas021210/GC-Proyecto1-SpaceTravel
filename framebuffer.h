...
constexpr size_t SCREEN_WIDTH = 1450;
...
void clearFramebuffer() {
    ...
    // Agregar estrellas al framebuffer
    for (int i = 0; i < 200; i++) {
        int x = rand() % SCREEN_WIDTH;  // Genera una posición aleatoria en el eje X
        int y = rand() % SCREEN_HEIGHT; // Genera una posición aleatoria en el eje Y
        FragColor star = stars;
